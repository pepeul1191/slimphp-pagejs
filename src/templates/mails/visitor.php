	...
	<center style="width: 100%; background-color: #f1f1f1;">
		...
		<div style="max-width: 600px; margin: 0 auto;" class="email-container">
			...
			<table role="presentation" style="margin: auto;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
				...
				<p style="color:#FFF">Somos una empresa dedicada a la capacitación y difusión de temas relacionados a las ciencias jurídicas.</p>
				</td>
				</tr>
				</tbody></table>
				</td>
