var dataTableRolePermission = {
  el: "#formTableRolePermission",
  idTable: "tableRolePermission",
  targetMensaje: "mensajeRptaRolPermission",
  mensajes: {
    errorListarAjax: "Error en listar los datos del servidor",
    errorGuardarAjax: "Error en guardar los datos en el servidor",
    success: "Se cargado guardo los cambios en los autores",
  },
  urlGuardar: BASE_URL + "access/role/permission/save",
  urlListar: BASE_URL + "access/role/permission/listar/",
  fila: {
    id: { // llave de REST
      tipo: "td_id",
